      ...
      <div className="right">
        <div className="intro">
          <p>I&apos;m a &apos;22 (junior) at Dartmouth College studying <span className="under">Computer Science.</span> I&apos;m interested
            ...
            Dartmouth, I&apos;m an incoming developer in the <span className="under">DALI Lab,</span>
            ...
            I enjoy learning about product & UI/UX design, reading about art history, making <span className="under">Spotify playlists,</span> and trying out new productivity
            tech/tools.
          </p>
        </div>
